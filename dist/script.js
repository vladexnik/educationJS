...
class VideoPlayer {
  ...
  createPlayer(url) {
    this.player = new YT.Player('frame', {
      // вместо frame подкл проигрыватель
      height: '100%',
      width: '100%',
      videoId: `${url}`
    });
...
class MiniSlider extends _slider__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  decorizeSlides() {
    ...
    if (!this.slides[0].closest('button')) {
      // если акт первый слайд - не кнопка
...
window.addEventListener('DOMContentLoaded', () => {
  let slider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_1__["default"]({
    btns: '.next',
    container: '.page'
  });
  slider.render();
  let showUpSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_0__["default"]({
  ...
  feedSlider.init();
  let player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.showup .play', '.overlay');
  player.init();
